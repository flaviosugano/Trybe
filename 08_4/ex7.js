...
/* ex7: Escreva uma função shipLength que, dado um objeto representando um navio, retorna o comprimento dele
mostrando também a devida unidade de comprimento: */

// escreva shipLength abaixo
shipLength = ({name, length, measurementUnit = 'meters'}) => `${name} is ${length} ${measurementUnit} long`
